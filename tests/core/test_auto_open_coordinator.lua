...
return function()
  ...
  assert(editBox.chatType == "PARTY", "expected sticky chat type restored on edit box")
  assert(editBox:GetAttribute("chatType") == "PARTY", "expected sticky chat type restored in secure state")
  assert(editBox.tellTarget == nil, "expected tell target cleared on edit box")
  ...
  assert(bnEditBox.chatType == "SAY", "expected BN sticky chat type restored on edit box")
  assert(bnEditBox:GetAttribute("chatType") == "SAY", "expected BN sticky chat type restored in secure state")
  assert(bnEditBox.tellTarget == nil, "expected BN tell target cleared on edit box")
