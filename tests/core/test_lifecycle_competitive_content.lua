...
return function()
  ...
  do
    ...
    assert(
      ...
      "should set _inCompetitiveContent=true when entering battleground"
    )
  end
  ...
  do
    ...
    assert(
      Bootstrap._inCompetitiveContent == true,
      "should set _inCompetitiveContent=true when entering arena"
    )
  end
  ...
  do
    ...
    assert(
      ...
      "should clear _inCompetitiveContent when entering open world"
    )
  end
  ...
  do
    ...
    assert(
      Bootstrap._inCompetitiveContent == true,
      "should set _inCompetitiveContent=true for mythic keystone"
    )
  end
  ...
  do
    ...
    assert(
      Bootstrap._inCompetitiveContent == false,
      "should clear _inCompetitiveContent on zone change out of pvp"
    )
  end

  _G.GetInstanceInfo = savedGetInstanceInfo
