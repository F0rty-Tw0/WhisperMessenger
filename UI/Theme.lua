...
Theme.COLORS = {
  ...
  bg_secondary          = { 0.10, 0.10, 0.14, 1.0 },
  bg_bubble_in          = { 0.12, 0.13, 0.18, 1.0 },
  bg_bubble_out         = { 0.15, 0.38, 0.55, 0.95 },
  bg_bubble_system      = { 0.14, 0.12, 0.10, 0.80 },
  bg_composer           = { 0.09, 0.09, 0.13, 1.0 },
  bg_header             = { 0.08, 0.08, 0.12, 1.0 },
  bg_contact_hover      = { 0.14, 0.15, 0.22, 1.0 },
  bg_contact_selected   = { 0.16, 0.18, 0.28, 1.0 },
  bg_input              = { 0.12, 0.12, 0.16, 1.0 },
  ...
  unread_badge          = { 0.20, 0.55, 0.95, 1.0 },
